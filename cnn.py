...
def build_data_generators(train_folder, test_folder, labels=None, image_size=(100, 100), batch_size=50):
    ...
    train_gen = train_datagen.flow_from_directory('training_set', target_size=image_size, class_mode='sparse',
                                                  batch_size=batch_size, shuffle=True, subset='training', classes=labels)
    test_gen = test_datagen.flow_from_directory('test_set', target_size=image_size, class_mode='sparse',
...
train_and_evaluate_model(model, name="Vegetable classification")
